...
func _ready():
	...
	change_texture(head_material, "res://Godime/textures/" + skin_color + ".png")
	...
	var dir_faces = DirAccess.open("res:///Godime/textures/face/pale/")
	...
	var dir = DirAccess.open("res:///Godime/headwear/")
	...
	var dir_clothes = DirAccess.open("res:///Godime/textures/clothes/pale/")
...
func get_headwear_model(model_name : String):
	var path = "res:///Godime/headwear/" + model_name + ".tscn"
	return path

func get_face_texture(texture_name : String):
	var path = "res:///Godime/textures/face/" + skin_color + "/" + texture_name + ".png"
	return path

func get_clothing_texture(texture_name : String):
	var path = "res:///Godime/textures/clothes/" + skin_color + "/" + texture_name + ".png"
	if texture_name == "skin":
		path = "res:///Godime/textures/" + skin_color + ".png"
	return path
