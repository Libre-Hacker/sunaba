...
func _ready():
	...
	var dir_faces = DirAccess.open("res:///CharacterSystem/textures/face/pale/")
	...
	var dir = DirAccess.open("res:///CharacterSystem/headwear/")
	...
	var dir_clothes = DirAccess.open("res:///CharacterSystem/textures/clothes/pale/")
...
func get_face_texture(texture_name : String):
	var path = "res:///CharacterSystem/textures/face/" + skin_color + "/" + texture_name + ".png"
	return path

func get_clothing_texture(texture_name : String):
	var path = "res:///CharacterSystem/textures/clothes/" + skin_color + "/" + texture_name + ".png"
