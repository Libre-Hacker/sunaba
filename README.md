...
This project is licensed under the GPL-3.0 And CC-BY 4.0 Licenses - see the [LICENSE.md (GPL-3.0) ](LICENSE.md) and [LICENSE.md (CC-BY 4.0) ](assets/LICENSE.md) files for details
